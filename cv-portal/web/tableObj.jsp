...
<html>
    <head>
        ...
        <link media="all" href="./css/scrow-table.css" rel="stylesheet"/>
                    ...
                    <div id="portal-column-content" class="cell width-3:4 position-1:4">
                        <div id="main-content">    
                            <div id="content">
                                ...
                                <fieldset>
                                    <br>
                                    <table id="sortValues" class="table table-hover table-striped table-bordered">
                                        <thead>
                                            <tr>
